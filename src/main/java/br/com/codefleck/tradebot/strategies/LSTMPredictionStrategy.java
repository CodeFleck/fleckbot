...
import br.com.codefleck.tradebot.daos.OrderStateDao;
 ...
 * @author Daniel Fleck
 */
public class LSTMPredictionStrategy implements TradingStrategy {
    ...
    //List<OrderState> lastOrderList = orderStateDao.all();
    //protected OrderState lastOrder = lastOrderList.get(lastOrderList.size()-1);
    protected OrderState lastOrder = null;

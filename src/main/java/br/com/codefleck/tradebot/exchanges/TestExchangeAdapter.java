...
public final class TestExchangeAdapter extends AbstractExchangeAdapter implements ExchangeAdapter {
   ...
   * at br.com.codefleck.tradebot.adapter.BitstampExchangeAdapter$DateDeserializer.deserialize(BitstampExchangeAdapter.java:596)
   * at br.com.codefleck.tradebot.adapter.BitstampExchangeAdapter$DateDeserializer.deserialize(BitstampExchangeAdapter.java:1)

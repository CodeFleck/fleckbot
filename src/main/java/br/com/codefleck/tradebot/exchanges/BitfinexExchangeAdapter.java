package br.com.codefleck.tradebot.exchanges;
...
public final class BitfinexExchangeAdapter extends AbstractExchangeAdapter implements ExchangeAdapter {
  ...
  public BalanceInfo getBalanceInfo() throws TradingApiException, ExchangeNetworkException {
    ...
    try {
      ...
      final HashMap<String, BigDecimal> walletsBalancesMap = new HashMap<>();
        ...
        allAccountBalances
            ...
            .forEach(accountBalance -> {
              if (accountBalance.currency.equalsIgnoreCase("usd")) {
                walletsBalancesMap.put("USD", accountBalance.available);
              } else if (accountBalance.currency.equalsIgnoreCase("btc")) {
                walletsBalancesMap.put("BTC", accountBalance.available);
              } else if (accountBalance.currency.equalsIgnoreCase("bch")) {
                walletsBalancesMap.put("BCH", accountBalance.available);
              } else if (accountBalance.currency.equalsIgnoreCase("dsh")) {
                walletsBalancesMap.put("DSH", accountBalance.available);
              } else if (accountBalance.currency.equalsIgnoreCase("iot")) {
                walletsBalancesMap.put("IOT", accountBalance.available);
              } else if (accountBalance.currency.equalsIgnoreCase("ltc")) {
                walletsBalancesMap.put("LTC", accountBalance.available);
              } else if (accountBalance.currency.equalsIgnoreCase("qtm")) {
                walletsBalancesMap.put("QTM", accountBalance.available);
              } else if (accountBalance.currency.equalsIgnoreCase("san")) {
                walletsBalancesMap.put("SAN", accountBalance.available);
              } else if (accountBalance.currency.equalsIgnoreCase("xmr")) {
                walletsBalancesMap.put("XMR", accountBalance.available);
              } else if (accountBalance.currency.equalsIgnoreCase("xrp")) {
                walletsBalancesMap.put("XRP", accountBalance.available);
              }
            });
      }

      return new BalanceInfoImpl(walletsBalancesMap, new HashMap<>());
   ...
   * </pre>
   */
  public static class BitfinexAccountBalance {

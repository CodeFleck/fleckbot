...
public class OneWeekPredictor {
    ...
    public List<String> predictOneWeek(List<StockData> stockDataList, String period, int batchSize, double splitRatio, PriceCategory category, int epochs, double learningRate) throws IOException {

        List<String> dataPointsList;

        StopWatch watch = new StopWatch();
        OneWeekStockDataSetIterator oneWeekIterator = iteratorService.getOneWeekStockDataSetIterator(stockDataList, batchSize, splitRatio, category);

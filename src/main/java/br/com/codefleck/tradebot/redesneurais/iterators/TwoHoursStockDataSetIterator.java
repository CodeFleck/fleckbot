...
@Component
public class TwoHoursStockDataSetIterator extends GeneralStockDataSetIterator implements DataSetIterator {
    ...
    private static TwoHoursStockDataSetIterator instance;

    private TwoHoursStockDataSetIterator(){}

    public static synchronized TwoHoursStockDataSetIterator getInstance(){
        if(instance == null){
            instance = new TwoHoursStockDataSetIterator();
        }
        return instance;
    }
    ...
    public static void setInstance(TwoHoursStockDataSetIterator instance) {
        TwoHoursStockDataSetIterator.instance = instance;
    }

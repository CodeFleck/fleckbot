...
@Component
public class OneDayStockDataSetIterator implements DataSetIterator {
    ...
    private static OneDayStockDataSetIterator instance;

    private OneDayStockDataSetIterator(){}

    public static synchronized OneDayStockDataSetIterator getInstance(){
        if(instance == null){
            instance = new OneDayStockDataSetIterator();
        }
        return instance;
    }
    ...
    public static void setInstance(OneDayStockDataSetIterator instance) {
        OneDayStockDataSetIterator.instance = instance;
    }

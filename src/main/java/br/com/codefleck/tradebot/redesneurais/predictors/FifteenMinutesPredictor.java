...
public class FifteenMinutesPredictor {
    ...
    public List<String> predictFifteenMinutes(List<StockData> stockDataList, String period, int batchSize, double splitRatio, PriceCategory category, int epochs, double learningRate) throws IOException {

        List<String> dataPointsList;

        StopWatch watch = new StopWatch();
        FifteenMinutesStockDataSetIterator fifteenMinutesStockDataSetIterator = iteratorService.getFifteenMinutesStockDataSetIterator(stockDataList, batchSize, splitRatio, category);

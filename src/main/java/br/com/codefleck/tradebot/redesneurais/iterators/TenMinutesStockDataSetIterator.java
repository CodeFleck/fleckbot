...
@Component
public class TenMinutesStockDataSetIterator extends GeneralStockDataSetIterator implements DataSetIterator {
    ...
    private static TenMinutesStockDataSetIterator instance;

    private TenMinutesStockDataSetIterator(){}

    public static synchronized TenMinutesStockDataSetIterator getInstance(){
        if(instance == null){
            instance = new TenMinutesStockDataSetIterator();
        }
        return instance;
    }
    ...
    public static void setInstance(TenMinutesStockDataSetIterator instance) {
        TenMinutesStockDataSetIterator.instance = instance;
    }

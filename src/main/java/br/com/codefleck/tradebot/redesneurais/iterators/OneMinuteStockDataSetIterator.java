...
@Component
public class OneMinuteStockDataSetIterator extends GeneralStockDataSetIterator implements DataSetIterator {
    ...
    private static OneMinuteStockDataSetIterator instance;

    private OneMinuteStockDataSetIterator(){}

    public static synchronized OneMinuteStockDataSetIterator getInstance(){
        if(instance == null){
            instance = new OneMinuteStockDataSetIterator();
        }
        return instance;
    }
    ...
    public static void setInstance(OneMinuteStockDataSetIterator instance) {
        OneMinuteStockDataSetIterator.instance = instance;
    }

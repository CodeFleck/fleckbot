...
@Component
public class FifteenMinutesStockDataSetIterator extends GeneralStockDataSetIterator implements DataSetIterator {
    ...
    private static FifteenMinutesStockDataSetIterator instance;

    private FifteenMinutesStockDataSetIterator(){}

    public static synchronized FifteenMinutesStockDataSetIterator getInstance(){
        if(instance == null){
            instance = new FifteenMinutesStockDataSetIterator();
        }
        return instance;
    }
    ...
    public static void setInstance(FifteenMinutesStockDataSetIterator instance) {
        FifteenMinutesStockDataSetIterator.instance = instance;
    }

...
public class ThirtyMinutesStockDataSetIterator implements DataSetIterator {
    ...
    private static ThirtyMinutesStockDataSetIterator instance;

    private ThirtyMinutesStockDataSetIterator(){}

    public static synchronized ThirtyMinutesStockDataSetIterator getInstance(){
        if(instance == null){
            instance = new ThirtyMinutesStockDataSetIterator();
        }
        return instance;
    }
    ...
    public static void setInstance(ThirtyMinutesStockDataSetIterator instance) {
        ThirtyMinutesStockDataSetIterator.instance = instance;
    }

...
@Component
public class OneMonthStockDataSetIterator extends GeneralStockDataSetIterator implements DataSetIterator {
    ...
    private static OneMonthStockDataSetIterator instance;

    private OneMonthStockDataSetIterator(){}

    public static synchronized OneMonthStockDataSetIterator getInstance(){
        if(instance == null){
            instance = new OneMonthStockDataSetIterator();
        }
        return instance;
    }
    ...
    public static void setInstance(OneMonthStockDataSetIterator instance) {
        OneMonthStockDataSetIterator.instance = instance;
    }

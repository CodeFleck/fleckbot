...
@Component
public class FourHoursStockDataSetIterator extends GeneralStockDataSetIterator implements DataSetIterator {
    ...
    private static FourHoursStockDataSetIterator instance;

    private FourHoursStockDataSetIterator(){}

    public static synchronized FourHoursStockDataSetIterator getInstance(){
        if(instance == null){
            instance = new FourHoursStockDataSetIterator();
        }
        return instance;
    }
    ...
    public static void setInstance(FourHoursStockDataSetIterator instance) {
        FourHoursStockDataSetIterator.instance = instance;
    }

...
public class CustomBaseTradingRecord implements CustomTradingRecord {
     ...
     * Constructor.
     */
    public CustomBaseTradingRecord() {
     ...
     */
    public CustomBaseTradingRecord(Order.OrderType entryOrderType) {
     ...
     */
    public CustomBaseTradingRecord(Order... orders) {

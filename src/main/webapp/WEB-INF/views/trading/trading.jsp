...
<template:admin>
    ...
    <jsp:body>
        ...
        <%--<div id="chartContainer" class="scrollgraph" style="height: 550px; width: 100%;"></div>--%>

        <%--<script type="text/javascript">--%>
          <%--window.onload = function () {--%>

            <%--var barCount = ${series.barCount};--%>

            <%--var dataPoints = [];--%>
            <%--for (var i = 0; i < barCount.length; i++) {--%>
              <%--var bar = barCount[i];--%>
              <%--dataPoints.push({--%>
                <%--x: new Date(${series.getBar(i).getOpenPrice()}),--%>
                <%--y: [--%>
                  <%--${series.getBar(0).getOpenPrice()},--%>
                  <%--${series.getBar(0).getMaxPrice()},--%>
                  <%--${series.getBar(0).getMinPrice()},--%>
